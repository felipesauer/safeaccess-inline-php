...
* **php:** bump friendsofphp/php-cs-fixer from 3.95.4 to 3.95.8 in /packages/php in the dev-dependencies group across 1 directory ([#72](https://github.com/felipesauer/safeaccess-inline/issues/72)) ([92da307](https://github.com/felipesauer/safeaccess-inline/commit/92da3074980aa3503beee2c2a3b808bcf963cb72))
* **php:** bump the dev-dependencies group across 1 directory with 2 updates ([#82](https://github.com/felipesauer/safeaccess-inline/issues/82)) ([c21f815](https://github.com/felipesauer/safeaccess-inline/commit/c21f81589b44eef833b635b259a0310145118329))

## [0.1.12](https://github.com/felipesauer/safeaccess-inline/compare/php-v0.1.11...php-v0.1.12) (2026-06-08)
...
## [0.1.11](https://github.com/felipesauer/safeaccess-inline/compare/php-v0.1.10...php-v0.1.11) (2026-06-08)


### Miscellaneous Chores

* **php:** bump the dev-dependencies group in /packages/php with 2 updates ([#67](https://github.com/felipesauer/safeaccess-inline/issues/67)) ([2f551f4](https://github.com/felipesauer/safeaccess-inline/commit/2f551f4a5ef006257fd0023797b9fdefcc687721))
...
* **php:** bump the dev-dependencies group in /packages/php with 2 updates ([#58](https://github.com/felipesauer/safeaccess-inline/issues/58)) ([30e8aad](https://github.com/felipesauer/safeaccess-inline/commit/30e8aad6e5b19b8486a0a31316a701453ddc297a))

## [0.1.8](https://github.com/felipesauer/safeaccess-inline/compare/php-v0.1.7...php-v0.1.8) (2026-05-04)


### Miscellaneous Chores

* **php:** bump phpstan/phpstan from 2.1.51 to 2.1.54 in /packages/php in the dev-dependencies group ([#50](https://github.com/felipesauer/safeaccess-inline/issues/50)) ([0dbcd37](https://github.com/felipesauer/safeaccess-inline/commit/0dbcd37f9c5cce5c1fc6285c7816dd49d04ea936))
